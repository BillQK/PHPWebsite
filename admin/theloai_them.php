                            ...
                            <form class="form-horizontal" method="post" action="" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="TenTL_KhongDau" name="TenTL_KhongDau" class="form-control" placeholder="Tên không dấu">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line abc">
                                                ...
                                                <input type="radio" id="AH2" name="AnHien" checked value="0">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line abc">
                                                ...
                                                <input type="radio" id="en" name="lang" checked value="en">
