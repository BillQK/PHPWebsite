          ...
          <div class="card">
              ...
              <div class="body">
                  <form id="form_validation" method="POST">
                      ...
                      <div class="form-group form-float">
                          <div class="form-line">
                              <textarea name="TomTat" cols="30" rows="5" class="form-control no-resize" placeholder="Tóm tắt" value="<?=$row['TomTat']?>" ></textarea>
                          </div>
                      </div>
                      <div class="form-group form-float">
                      	  <div class="form-line">
                          	  <input type="text" name="urlHinh" id="urlHinh" class="form-control" placeholder="Địa chỉ hình của tin" value="<?=$row['urlHinh']?>">
                          </div>
                      </div>
                      ...
                      <div class="row cleafix">
                          ...
                          <div class="col-md-6">
                          	  <div class="form-group form-float">
                              	  <div class="form-line">
                                  	  <input class="form-control" name="Ngay" placeholder="Ngày đăng" value="<?=date('d/m/Y',strtotime($row['Ngay']))?>">
                                  </div>
                              </div>
                          </div>
                      </div>
