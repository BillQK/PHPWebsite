...
$DemT=0; //Tạo vòng lặp từ 0 -> $totalRows; Gắn vào $DemT 
?>
<style>
...
<ul class="pagination clearfix page_margin_top_section">
    <?php if ($pageNum > 1 ) {?>
    <li>
    <a href="index.php?cat&idLT=<?=$idLT?>">Đầu</a>
    </li>
    <li>
    <a href="index.php?cat&idLT=<?=$idLT?>&pageNum=<?=$pageNum?>">Trước</a>
    </li>
    <?php } ?>
   ...
   <?php } ?>
    ...
    <li>
    <a href="index.php?cat&idLT=<?=$idLT?>&pageNum=<?=$pageNext?>">Sau</a>
    </li>
    <li>
    <a href="index.php?cat&idLT=<?=$idLT?>&pageNum=<?=$$totalPages?>">Cuối</a>
    </li>
    <?php } ?>
</ul>
<?php } ?> 
